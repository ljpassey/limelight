...
export function Hero() {
  return (
    <Container className="pb-32 pt-20 text-center lg:pt-32">
      <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
        Job preparation{' '}
        <span className="relative whitespace-nowrap text-lime-500/90">
          <svg
            aria-hidden="true"
            viewBox="0 0 418 42"
            className="absolute left-0 top-2/3 h-[0.58em] w-full fill-lime-700/70"
      ...
      <div className="mt-10 flex justify-center gap-x-3">
        ...
        >
          <svg
            aria-hidden="true"
            className="h-3 w-3 flex-none fill-lime-700 group-active:fill-current"
          >
